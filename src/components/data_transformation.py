#Data Trasformation: feature enngineerig ,data cleaning
import sys
...
class DataTransformation:
        ...
        try:
            ...
            cat_pipeline=Pipeline(
                steps=[
                    ...
                    ("one_hot_encoder",OneHotEncoder()),                                          #can use target_guided_encoder or other encoder
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Applying preprocessor object on trainingDF and testingDF ")
